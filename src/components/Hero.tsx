      ...
      <div className="relative z-10 min-h-screen w-full flex items-center justify-center py-8 sm:py-12 px-4 sm:px-6">
        <div className="text-center mx-auto max-w-md sm:max-w-lg md:max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-2">
            <button className="w-full sm:w-auto px-6 sm:px-8 py-3 text-sm sm:text-base font-bold rounded-full bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">
              {registerButtonText}
            </button>

            <button className="w-full sm:w-auto px-6 sm:px-8 py-3 text-sm sm:text-base font-medium rounded-full border border-white/30 text-white hover:bg-white/10 transition-colors">
              {detailsButtonText}
            </button>
          </div>
        </div>
